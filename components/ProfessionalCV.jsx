...
const ProfessionalCV = () => {
    ...
    if (loading) {
        return (
            <section className="bg-gray-50 dark:bg-slate-950/20 py-12 md:py-20">
                <div className="max-w-5xl mx-auto p-6 bg-white dark:bg-slate-900 rounded-lg shadow-xl">
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                        {/* Kolom Kiri */}
                        <div className="md:col-span-1 text-center md:text-left flex flex-col items-center md:items-start">
                            <div className="w-40 h-40 md:w-48 md:h-48 rounded-full mb-6 bg-slate-200 dark:bg-slate-800 animate-shimmer"></div>
                            <div className="space-y-3 w-full max-w-[200px] flex flex-col items-center md:items-start">
                                <div className="h-6 w-5/6 bg-slate-200 dark:bg-slate-800 rounded animate-shimmer"></div>
                                <div className="h-4 w-2/3 bg-slate-200 dark:bg-slate-800 rounded animate-shimmer"></div>
                                <div className="h-4 w-1/2 bg-slate-200 dark:bg-slate-800 rounded animate-shimmer"></div>
                            </div>
                        </div>
                        {/* Kolom Kanan */}
                        <div className="md:col-span-2 space-y-8">
                            <div className="space-y-4">
                                <div className="h-8 w-24 bg-slate-200 dark:bg-slate-800 rounded animate-shimmer"></div>
                                <div className="space-y-2">
                                    <div className="h-4 w-full bg-slate-200 dark:bg-slate-800 rounded animate-shimmer"></div>
                                    <div className="h-4 w-full bg-slate-200 dark:bg-slate-800 rounded animate-shimmer"></div>
                                    <div className="h-4 w-4/5 bg-slate-200 dark:bg-slate-800 rounded animate-shimmer"></div>
                                </div>
                            </div>
                            <div className="space-y-4">
                                <div className="h-8 w-32 bg-slate-200 dark:bg-slate-800 rounded animate-shimmer"></div>
                                <div className="space-y-3">
                                    <div className="h-6 w-2/3 bg-slate-200 dark:bg-slate-800 rounded animate-shimmer"></div>
                                    <div className="h-4 w-1/2 bg-slate-200 dark:bg-slate-800 rounded animate-shimmer"></div>
                                    <div className="h-3 w-1/4 bg-slate-200 dark:bg-slate-800 rounded animate-shimmer"></div>
                                </div>
                            </div>
                        </div>
                    </div>
