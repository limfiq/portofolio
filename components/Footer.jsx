...
const Footer = () => {
    return (
        <footer className="bg-slate-900 dark:bg-slate-950 text-slate-350 py-16 border-t border-slate-200/10 dark:border-slate-800/60 mt-20 md:mt-32 w-full select-none">
                ...
                <div className="grid grid-cols-1 md:grid-cols-12 gap-10 md:gap-8 mb-12">
                    ...
                    <div className="md:col-span-3">
                        ...
                        <ul className="space-y-3 text-sm">
                            <li><Link href="/about" className="text-slate-400 hover:text-blue-400 hover:underline transition-colors">Tentang Saya</Link></li>
                            <li><Link href="/publications" className="text-slate-400 hover:text-blue-400 hover:underline transition-colors">Publikasi Ilmiah</Link></li>
                            <li><Link href="/penelitian-pengabdian" className="text-slate-400 hover:text-blue-400 hover:underline transition-colors">Penelitian & Pengabdian</Link></li>
                            <li><Link href="/lecturer" className="text-slate-400 hover:text-blue-400 hover:underline transition-colors">Aktivitas Mengajar</Link></li>
                            <li><Link href="/contact" className="text-slate-400 hover:text-blue-400 hover:underline transition-colors">Kontak</Link></li>
                        </ul>
                    </div>
                    ...
                    <div className="md:col-span-3">
                        ...
                        <ul className="space-y-3 text-sm text-slate-400">
                            <li className="flex items-center gap-2">
                                ...
                                <a href="mailto:ufiq@limfiq.my.id" className="hover:text-blue-450 transition-colors">
                                    ufiq@limfiq.my.id
                                </a>
                            </li>
                            <li className="flex items-center gap-2">
