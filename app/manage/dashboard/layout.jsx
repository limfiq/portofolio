...
const TeachingIcon = () => <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253" /></svg>;
        ...
        <div className="min-h-screen flex bg-gray-100">
            ...
            <aside className="w-64 bg-gray-800 text-white flex flex-col">
                ...
                <nav className="flex-1 px-4 py-4 space-y-2">
                    ...
                    <Link href="/manage/dashboard/teaching" className="flex items-center px-4 py-3 text-gray-200 hover:bg-gray-700 rounded-lg transition-colors duration-200">
                        <TeachingIcon />
                        <span className="ml-4 font-medium">Pengajaran</span>
                    </Link>
