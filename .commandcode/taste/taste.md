...
- When a requested data source is blocked or unavailable (e.g., loker.id behind Cloudflare), prefers the assistant to actively find and evaluate alternative sources rather than stopping at the limitation ("ok coba carikan lagi"). Confidence: 0.6
